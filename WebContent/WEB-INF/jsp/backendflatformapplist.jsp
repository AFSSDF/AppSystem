				...
				<div class="row">
					<div class="col-md-12">
						<div class="x_panel">
							...
							<div class="x_content">
								<form
									action="${pageContext.request.contextPath }/backend/flatform/app/list"
									method="get">
									<ul>
										...
										<tbody>
											<c:forEach items="${appInfos}" var="appInfo">
												<tr>
													...
													<th><button status="${appInfo.status}"
															versionid="${appInfo.versionId}"
															appinfoid="${appInfo.id}" type="button"
															class="btn btn-default checkApp">审核</button></th>
												</tr>
											</c:forEach>
										</tbody>
									</table>
